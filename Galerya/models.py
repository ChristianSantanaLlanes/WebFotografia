...
class Secciones(models.Model):
    ...
    imagen=models.ImageField(upload_to='secciones', null=True, help_text='Las fotos deben ser 675x675 ')
...
class Album(models.Model):
    ...
    imagen=models.ImageField(upload_to='album', help_text='La foto de tu album')
